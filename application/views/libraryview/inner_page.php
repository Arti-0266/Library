  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container">
      <div class="header-container d-flex align-items-center justify-content-between">
        <div class="logo">
          <h1 class="text-light"><a href="index.html"><span>Library</span></a></h1>
          ...
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>Get Involved</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                    ...
                    <li><a href="donation.html">Proud Donor</a></li>
                    <li><a href="request_book.html">Request for Books</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Free Delivery</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Help Organisations</a></li>
